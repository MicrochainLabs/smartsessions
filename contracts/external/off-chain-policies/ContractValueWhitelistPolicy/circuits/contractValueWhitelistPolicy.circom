...
template AccountTransactionValidation(transactionNumber, smartContractTreeLevels, toTreeLevels) {
    ...
    signal input accountIdentifier;//smart account
    signal input sessionIdentifier;//permissionId
    signal input allowedSmartContractTreeRoot;//contractWhitelistRoot
    signal input allowedToTreeRoot; //valueWhitelistRoot
    signal input op;//userOp Hash
